...
export async function callClaudeForJson({ apiKey, systemPrompt, userPrompt }) {
...
// Maps each action name (the path segment under /api/) to its system prompt
// and the function that builds the user prompt from the request body.
